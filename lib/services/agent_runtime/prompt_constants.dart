...
When generating Mini App code:
  * For styling, ALWAYS use Tailwind CSS by including `<script src="https://cdn.tailwindcss.com"></script>` in the `<head>`. Create beautiful, modern, dark-mode/glassmorphism UI elements that match the Meow Agent aesthetic (rounded corners, soft shadows, slate/indigo/cyan/violet/rose color palettes).

...
- CONTENT COMPLETENESS (generic, any app — read/summarize/extract goals):
  * Do NOT accept status="done" for a summary/extraction built from CLIPPED text when an inline expand affordance ("see more / read more / …" in any language) was visible and unclicked. Return status="continue" so the selector expands it first, then re-inspects.
